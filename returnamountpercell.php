...
if (strlen($_SESSION['emplogin']) == 0) {
    ...
    $BorrowId = $_GET['id'];
    $sql = "SELECT a.BorrowId,a.BorrowAmount,b.typePercelAmount,b.TypePercelIdAuto FROM tbborrow as a 
    ...
    if (isset($_POST['add'])) {
        ...
        $sql1 = "update tbborrow set BorrowAmount=:resulttbborrow where BorrowId=:BorrowId";
