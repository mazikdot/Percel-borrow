                ...
                <div class="col s12 m12 l12">
                    <div class="card">
                        <div class="card-content">
                            <h5 style="text-align:center;">พัสดุในระบบ</h5>
                            ...
                            <table id="example" class="display responsive-table ">
                                ...
                                <tbody>
                                    <?php $sql = "SELECT a.TypePercelName,a.TypePercelIdAuto,a.TypePercelId,b.PercelName FROM tbtypepercel as a INNER JOIN tbpercel as b ON a.PercelIdAuto = b.PercelIdAuto;";
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $result) {               ?>
                                            <tr>
                                                ...
                                                <td><a href="updatetypepercel.php?id=<?php echo $result->TypePercelIdAuto;  ?>"><i class="material-icons">mode_edit</i></a>
                                                    <button style="border: none; outline: none; background: none;" onCLick="deleteTypePercel(<?php echo htmlentities($result->TypePercelIdAuto); ?>)"><i class="material-icons">delete_forever</i></button>
                                                </td>
                                            </tr>
                                    <?php
                                        }
