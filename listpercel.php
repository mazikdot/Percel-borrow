            ...
            <div class="col s12 m12 l12">
                <div class="card">
                    <div class="card-content">
                        <h5 style="text-align:center;">รายการพัสดุที่สามารถยืมได้</h5>
                                ...
                                if ($query->rowCount() > 0) {
                                    foreach ($results as $result) {               ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($result->typePercelAmount != 0) { ?>
                                                    <a href="borrowpercel.php?id=<?php echo $result->TypePercelIdAuto;  ?>"><i class="material-icons">mode_edit</i>ยืม</a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                <?php
